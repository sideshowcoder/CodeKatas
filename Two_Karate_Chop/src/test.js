(function() {
  ...
  $(function() {
    test("No array passed", function() {
      equal(karate.chop(1, null), -1);
      return equal(karate.chop(1, "xyz"), -1);
    });
    test("Array length 1", function() {
      equal(karate.chop(1, [0]), -1);
      return equal(karate.chop(1, [1]), 0);
    });
    test("Array length > 1 Number contained", function() {
      ...
      return equal(karate.chop(3, [0, 1, 2, 3]), 3);
    });
    return test("Array length > 1 Number not contained", function() {
      ...
      return equal(karate.chop(5, [1, 2, 3, 4]), -1);
    });
  });
